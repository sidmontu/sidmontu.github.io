...
%  	\pointskill{\flag{FR.png}}{French}{3}
	...
	\profilesection{Software}
        ...
        \skill{\faReact}{Product design with ReactJS / Redux / SASS}
        \skill{\faChartBar}{Data analysis/visualizations in R}
        \skill{\faCuttlefish}{C/C++ programming on embedded systems}
...
\vspace{-0.3in}
\begin{cvtable}[3]
    \cvitem{Feb'20 -- Present}{Founder, CTO \& Director}{inPact.ai}{
	...
	\cvitem{Oct'17 -- Dec'19}{Postdoctoral Research Associate}{University of Sydney}{
        ...
        \begin{tabular}{L{4mm}L{100mm}}
            ...
            \raisebox{2\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\small (Co-)Authored 5 peer-reviewed research papers/posters during the stint at the lab.}\\
