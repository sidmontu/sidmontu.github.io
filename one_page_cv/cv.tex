...
\begin{cvtable}[3]
    \cvitem{Jun'21 -- Present}{Machine Learning Engineer (Contract)}{SAP Asia Pte Ltd}{
        ...
        \begin{tabular}{L{4mm}L{100mm}}
            &\\[-0.1in]
            \raisebox{2\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\small Part of the machine learning engineering team to build scalable and production-ready ML-driven solutions for internal stakeholders.}\\
            \raisebox{0.25\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\small Worked with ElasticSearch, Docker, FastAPI, Agile, ReactJS, etc.}\\
        \end{tabular}
    }
