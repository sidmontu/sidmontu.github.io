...
\cvname{Siddhartha}
% job title/career
\cvjobtitle{Machine Learning/FPGA Engineer}
...
\addtofrontsidebar{
	...
	\aboutme{
        ...
        applied AI and machine learning engineering projects, with/without
...
%  	\pointskill{\flag{FR.png}}{French}{3}
	...
	\profilesection{Software}
        \skill{\faLinux}{Experienced with UNIX and CLI}
        \skill{\faPython}{Strong Python developer}
        \skill{\faCogs}{PyTorch/Tensorflow + Tensorpack machine learning frameworks}
        % \skill{\faToolbox}{MLOps tools such as MLFlow, Hub, and Label Studio}
        \skill{\faReact}{Product development with ReactJS / Redux / SASS}
	...
	\profilesection{Hardware}
        \skill{\faUniversity}{Possess foundational knowledge}
        \skill{\faKeyboard}{Proficient with (System)Verilog}
    ...
    \profilesection{Deployment}
        \skill{\faAws}{Hands-on experience with AWS cloud products}
        \skill{\faServer}{Serverless Application Framework}
        \skill{\faBrain}{Cortex.dev for ML inference deployment and monitoring}
...
\vspace{-0.2in}
\begin{cvtable}[3]
    \cvitem{Jun'20 -- Present}{Machine Learning Engineer (Contract)}{SAP Asia Pte Ltd}{
        \renewcommand{\arraystretch}{1.2}% Tighter
        \begin{tabular}{L{4mm}L{100mm}}
            &\\[-0.1in]
            \raisebox{2\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\small Part of the machine learning engineering team to build scalable and production-ready ML-driven applications for internal stakeholders.}\\
            \raisebox{0.25\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\small Worked with/on ElasticSearch, Docker, FastAPI, Agile, ReactJS, etc.}\\
        \end{tabular}
    }
    ...
    \cvitem{Feb'20 -- Present}{Founder \& CTO}{inPact.ai}{
        ...
        \begin{tabular}{L{4mm}L{100mm}}
            ...
            \raisebox{4.75\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\small Hired and managed contractors and an intern to meet product development targets regularly. Enforced good development practices such as version control, linters, code reviews, etc.}\\
            ...
            \raisebox{2\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\small Hands-on experience with ReactJS, the serverless framework, and services provided by the AWS cloud infrastructure.}\\
	...
	\cvitem{Oct'17 -- Dec'19}{Postdoctoral Research Associate}{University of Sydney}{
        ...
        \begin{tabular}{L{4mm}L{100mm}}
            ...
            \raisebox{2\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\small Core team member on a project (High-Speed Machine Learning for RF Communication) commissioned by the Australian Defense Force.}\\
...
\begin{cvtable}[1.5]
	\cvitem{2013 -- 2019}{Doctor of Philosophy}{Nanyang Technological University, Singapore}{
        ...
        \raisebox{0\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\footnotesize
            Introduced DaCO, a Dataflow Coprocessor Overlay optimized for Arria
            10 FPGAs.
        }\\
        ...
        \raisebox{1.75\height}{\tikz \fill [cvblue] (-0.07,-0.2) rectangle (0.07,-0.05);} & {\footnotesize (Co-)Authored a total of 15 research papers/posters/journals at top-tier IEEE conferences during the candidacy.}\\
        \end{tabular}
    }
...
\begin{cvtable}
    \cvpubitem{\textcolor{cvblue}{\href{https://www.coursera.org/specializations/machine-learning-engineering-for-production-mlops}{\it Machine Learning Engineering for Production (MLOps) Specialization}}}{Coursera MOOC offered by DeepLearning.AI}{4-module specialization focusing on best in-industry practices for building and deploying end-to-end production-ready machine learning systems. Instructors include Andrew Ng (founder DeepLearning.AI and Coursera), Robert Crowe (Tensorflow Developer Engineer, Google), Laurence Moroney (Lead AI Advocate, Google), and more.}{Ongoing}
