...
\begin{document}
\makeheading{{\Huge Siddhartha}\hfill{\normalsize Machine Learning / FPGA Engineer }}
...
%
\begin{tabular}[t]{@{}p{\textwidth-\rcollength-1.8in}p{2\rcollength}}
...
\includegraphics[width=12px]{email_logo}\ \ \ \textcolor{black}{\textsf{sidmontu@gmail.com}} & 
	...
	\includegraphics[width=12px]{github_logo}\ \ \ \raisebox{0.3\height}{\textcolor{black}{\href{https://github.com/sidmontu}{\textsf{github.com/sidmontu}}}} \\
...
learning applications. My past research projects involve developing high-speed,
...
accelerating highly sparse and irregular workloads, and more.

\vspace{0.1in}

For the last 12 months, I have been building AI-driven products as a founder of
my own company (inPact.ai). I have worn multiple hats in this role; from core
technology development of the complete product stack (frontend, backend, and
AI) to founder duties that include hiring, customer acquisition, fundraising,
project management, etc.

% I am a strong programmer and lifelong learner who has a keen interest in
% doing cutting-edge research and development.

\section{Experience}

\textbf{CTO/Founder} \hfill {May 2020 to Present}
\begin{innerlist}

\item[] Inpact Technologies Pte Ltd (inPact.ai), Singapore

        \vspace{0.1in}

        {\bf As a CTO:}
        \begin{itemize}
            % \item Responsibilities include developing the core machine
            % learning technology served through a robust product with pleasing
            % UI/UX. Technology stacks I have worked on (non-exhaustive):
            % PyTorch/spaCy for training deep neural networks, Label Studio for data
            % annotation, MLFlow for model registry, Hub for dataset/feature store,
            % Cortex.dev for model deployment and monitoring, ReactJS for frontend
            % web client, serverless backend, AWS infrastructure for deployment, and
            % more.
            \item Led product development across all aspects of machine learning, frontend, backend, and deployment.
            \item Hired and managed contractors and an intern to meet product development targets regularly. Enforced good development practices such as version control, linters, code reviews, etc.
            \item Gained hands-on development experience with MLOps tools: Label studio for data annotation, MLFlow for model registry, Hub for dataset/feature store, and Cortex.dev for model deployment.
            \item Hands-on experience with ReactJS and serverless frameworks. Setup inPact’s cloud infrastructure on AWS -- used a myriad of AWS cloud services such as Cognito, DynamoDB, S3, SNS, Lambda, etc.
        \end{itemize}
        ...
        \begin{itemize}
            ...
            % Handling business functions such as hiring (interns
            % and contractors), customer acquisition, corporate partnerships,
            % investor relations, fundraising, project management, marketing, and
            % more.

            \item Handled business functions such as customer acquisition, corporate partnerships, investor relations, fundraising, marketing, and more.
            \item Raised S\$75K pre-seed from Entrepreneur First, an international VC firm funded by Reid Hoffman (founder of LinkedIn), founders of DeepMind and PayPal, and some of the top investors in the world.
        \end{itemize}
...
\item[] Computering Engineering Lab,\\
        ...
        Responsibilities included: research \& development on the ``High-Speed
        Machine Learning for RF Communications'' project commissioned by the
        Australian Defense Agency, research \& development on other ongoing
        projects in the lab (5 papers published at peer-reviewed conferences),
        supervising final-year undergraduate students on their research
        projects, sysadmin duties on local compute resources, etc.
...
\item[] Circuits and Systems Research Group,\\
        ...
        on recommendation from supervisor Dr. Nachiket Kapre. Worked on acyclic
        dataflow graph reassociation techniques for sparse matrix workloads;
        work that eventually served as a foundation for subsequent PhD research
        and was published in peer-reviewed conferences.
\end{innerlist}
