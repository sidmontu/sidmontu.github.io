...
\begin{document}
\makeheading{{\Huge Siddhartha}\hfill{\large Hardware/Software Engineer }}
...
\includegraphics[width=12px]{email_logo}\ \ \ \textcolor{black}{\textsf{sidmontu@gmail.com}} & 
    ...
    \includegraphics[width=12px]{globe_logo}\ \ \ \textcolor{black}{\href{https://sidmontu.github.io}{\bf https://sidmontu.github.io}} & 
	\includegraphics[width=12px]{github_logo}\ \ \ \raisebox{0.3\height}{\textcolor{black}{\href{https://github.com/sidmontu}{\bf github.com/sidmontu}}} \\
...
background. Interested in projects at the crossroads of hardware design and
modern deep learning applications.
% Referees available on request.
% background looking for a fresh challenge. Especially interested in applied AI
% and ML infrastructure projects (e.g. MLOps), with/without hardware
% acceleration (e.g. FPGAs/ASICs) as an auxiliary goal. Referees on request.

{
    \hspace*{-\marginparsep minus \marginparwidth}%
    \begin{minipage}[t]{\textwidth+\marginparwidth+\marginparsep}%
         \rule{\columnwidth}{1pt}\\[-1.4\baselineskip]%
         \begin{center}{\large \bfseries Work Experience}\end{center}
         \vspace{-0.18in}
         \rule{\columnwidth}{1pt}\\[-1.4\baselineskip]%
    \end{minipage}
}\\[.5\baselineskip]
...

{
    ...
    \begin{minipage}[t]{\textwidth+\marginparwidth+\marginparsep}%
        ...
        \textbf{Research Engineer, AMD Research, Singapore} \hfill {Jan 2022 to Present}

        \vspace{0.1in}
        \begin{myinnerlist}
            \renewcommand{\labelitemi}{\localtextbulletone}

            \item Working on research projects focusing on topics such as hardware
                design, computer networks, and machine learning.

            \item Published
                \href{https://dl.acm.org/doi/abs/10.1145/3630047.3630191}{\bf
                demo proposal} at EuroP4'23 on high-speed DNN-based anomaly
                detector in the network data plane.

            \item Lead projects and mentor interns throughout the year.
        ...
        \begin{myinnerlist}
            ...
            \item Frontend using \href{https://react-redux.js.org/}{\bf
                ...
                % Hands-on experience with technologies/frameworks such as
        ...
        \begin{myinnerlist}
            ...
            \item Contribution to other FPGA-based research projects in the lab on
                ...
                % Total 5 research papers/posters published at peer-reviewed conferences.
...

{
    ...
    \begin{minipage}[t]{\textwidth+\marginparwidth+\marginparsep}%
        ...
        % {\color{darkgray}\small Offered through the Coursera MOOC platform}
        % \begin{innerlist}
...

{
    ...
    % \begin{minipage}[t]{\textwidth+\marginparwidth+\marginparsep}%
        ...
        \begin{enumerate}
            \item {\bf Siddhartha}, Justin Tan, Rajesh Bansal, Huang Chee Cheun, Yuta Tokusashi, Chong Yew Kwan, Haris Javaid, and Mario Baldi ``Demo: Enabling DNN Inference in the Network Data Plane" \emph{Proceedings of the 6th European P4 Workshop (co-located with CoNEXT 2023)}, Dec 2023\newline[\href{https://dl.acm.org/doi/abs/10.1145/3630047.3630191}{\texttt{DOI: 10.1145/3630047.3630191}}]
            \item Stephen Tridgell, David Boland, Philip Leong, Ryan Kastner, Alireza Khodamoradi, and {\bf Siddhartha} ``Real-time Automatic Modulation Classification using RFSoC" \emph{27th Reconfigurable Architectures Workshop (co-located with IPDPS 2020)}, May 2020\newline[\href{https://doi.org/10.1109/IPDPSW50202.2020.00021}{\texttt{DOI: 10.1109/IPDPSW50202.2020.00021}}]
