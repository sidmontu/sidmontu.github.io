...
\item[] Inpact Technologies Pte Ltd (inPact.ai), Singapore
        ...
        {\bf As a CTO}: Core responsibilities include developing the core
        machine learning technology integrated into a competent product with
        pleasing UI/UX. Technology stacks I have worked on (non-exhaustive):
        ...
        {\bf As a Founder}: Handling business functions such as hiring (interns
