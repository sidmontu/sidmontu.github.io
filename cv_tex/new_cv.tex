...
\begin{document}
\makeheading{{\Huge Siddhartha}\hfill{\large Software Engineer }}
...
Machine Learning, MLOps, FPGAs, HFT, HPC, RF Communications
...
and ML infrastructure projects (e.g. MLOps), with/without hardware acceleration
(e.g. FPGAs/ASICs) as an auxiliary goal. Referees on request.
...

{
    ...
    \begin{minipage}[t]{\textwidth+\marginparwidth+\marginparsep}%
        ...
        \begin{outerlist}
            \item[] BEng, {Electrical \& Electronics Engineering}, 2nd Upper Class Honors
        \end{outerlist}
