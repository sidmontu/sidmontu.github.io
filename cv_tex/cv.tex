...
\begin{document}
\makeheading{{\Huge Siddhartha}\hfill{\normalsize FPGA / Machine Learning Engineer}}
...
Machine Learning, FPGAs, Computer Architectures, Communication Systems
...
\item[] Computering Engineering Lab,\\
        ...
        Project: High-speed machine learning on FPGAs\\
...
\end{innerlist}
\vspace{0.1in}
\textbf{Undergraduate Researcher} \hfill {July 2012 to September 2012}
\begin{innerlist}
