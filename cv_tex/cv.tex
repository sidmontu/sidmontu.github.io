...
\begin{innerlist}
\item {\bf Verilog} : Competent with the language -- completed multiple large research projects using associated compilation/simulation tools.
...
\vspace{-.1158in}
\begin{enumerate}
\item {\bf Siddhartha}, and Nachiket Kapre ``DaCO: A High-Performance Token Dataflow Coprocessor Overlay for FPGAs" \emph{International Conference on Field-Programmable Technology}, December 2018 (Poster)%\newline[\texttt{DOI: 10.1109/MILCOM.2018.8599833}]
...
{\bf Project Supervisor, University of Sydney} \hfill {Semesters 2018--Present}
\begin{innerlist}[rightmargin=\dimexpr\linewidth-6.5cm-\leftmargin\relax] 
\item[] Guidance and supervision given to multiple undergraduate students on their final year project.
\end{innerlist}
\vspace{0.1in}
